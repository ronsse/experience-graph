...
from xpgraph.schemas.enums import OutcomeStatus
...
if TYPE_CHECKING:
    from xpgraph.stores.event_log import EventLog
    from xpgraph.stores.trace import TraceStore
    from xpgraph_workers.enrichment.service import LLMCallable
...
class PrecedentMiner:
    ...
    async def generate_precedent_candidates(
        ...
        *,
        ...
        return self._parse_candidates(response, analyzed, domain)
