"""Vault indexer — indexes Obsidian notes into Experience Graph stores."""
...
class VaultIndexer:
    """Indexes Obsidian vault notes into xpgraph stores.
