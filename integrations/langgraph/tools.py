"""Experience Graph tools for LangGraph agents.
...
_client: XPGClient | None = None


def _get_client(base_url: str | None = None) -> XPGClient:
    """Get or create a module-level XPGClient."""
    global _client  # noqa: PLW0603
    if _client is None:
        _client = XPGClient(base_url=base_url)
    return _client
...
def create_xpg_tools(
    ...
    """
    client = XPGClient(base_url=base_url)
