...
Skipped unless ``XPG_TEST_PG_DSN`` is set and psycopg/pgvector are importable.
"""
...
DSN = os.environ.get("XPG_TEST_PG_DSN", "")

pytestmark = [
    pytest.mark.postgres,
    pytest.mark.skipif(not DSN, reason="XPG_TEST_PG_DSN not set"),
]
